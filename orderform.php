							...
							<form action="" method="POST" class="registration">
								...
								<h3 style="color:black ;font-size:18px; padding: 5px;">Accepting CashOnDelivery Only</h3>
									...
									Types of Delivery <br>
									 ...
									 <input name="Delivery" required="required" value="Express Delivery +Rs.100 upon delivery" type="radio"  placeholder="Mode Of Payment">Express </br>
									 <input name="Delivery" type="radio" value="Standard Delivery" required="required" placeholder="Mode Of Payment">Standard </br>
									 </font>
