			...
			echo '
				...
				<div style="float: left;width: 40%;color: black;padding: 10px;text-align:center;margin-left:40px;font-size:20px;">
					<div style="">
						...
						<h3 style="padding: 20px 0 0 0; font-size: 20px;">Price:Rs.'.$price.'</h3>
						...
						<div>
							...
							<div id="srcheader">
								<form id="" method="post" action="">
								        <input type="submit" name="addcart" value="Add to cart" class="srcbutton" style="color:black"  >
								</form><br/>
								<form id="" method="post" action="../orderform.php?poid='.$pid.'">
								        <input type="submit" value="Order Now" class="srcbutton" style="color:black" >
								</form>
