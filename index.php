...
<html>
	...
	<body style="min-width: 980px; background-image: url(image/bk.jpg); background-position: center center; background-repeat: no-repeat; background-size: cover;">
		<div class="homepageheader" style="position: relative;">
			<div class="signinButton loginButton">
				...
				<div class="uiloginbutton signinButton loginButton" style="margin-right: 40px;">
					<?php
						if ($user!="") {
							echo '<a style="text-decoration: none; color: black;" href="logout.php">LOG OUT</a>';
						}
						else {
							echo '<a style="color: black; text-decoration: none;" href="signin.php">SIGN UP</a>';
						}
					 ?>
				</div>
				...
				<div class="uiloginbutton signinButton loginButton" >
					<?php
						if ($user!="") {
							echo '<a style="text-decoration: none; color: black;" href="profile.php?uid='.$user.'">MY OPERATIONS</a>';
						}
						else {
							echo '<a style="text-decoration: none; color: black;" href="login.php">USER LOG IN</a>';
						}
					 ?>
				</div>
		...
		<div class="home-welcome">
			<?php
				if ($user!="") {
					...
					echo'<h1 class="title" style="margin: 0px;color:black;font-family: tahoma;text-shadow: 4px 3px 4px grey;font-size:25px;font-family: tahoma;">Hi '.$uname_db.' '.$lname_db.'</h1>';
					echo "</div>";
					echo "<center><div>";
						echo '<img src="image/logo.png" alt="" style="width:15%; margin-top:2%;">';
						echo'<h1 class="title" style="margin: 0px;color:black;font-family: tahoma;text-shadow: 4px 3px 4px grey;font-size:50px;font-family: tahoma;">Music Instrument Shop</h1>';
					echo "</div></center>";
					...
					<?php
						if (!$user) {
							echo "<center><div>";
								...
								echo'<h1 class="title" style="margin: 0px;color:black;font-family: tahoma;text-shadow: 4px 3px 4px grey;font-size:50px;font-family: tahoma;">Music Instrument Shop
								</h1>';
							echo "</div></center>";
						}
					 ?>
      ...
      <div class="wrapper">
          ...
          <div class="copyright">Contact Us: 4564564567</div>
			</div>
	</body>
</html>
