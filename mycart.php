	...
	<div class="homepageheader">
			<div class="signinButton loginButton">
				<div class="uiloginbutton signinButton loginButton" style="margin-right: 40px;">
					<?php
						if ($user!="") {
							...
							echo '<a style="text-decoration: none; color: black;" href="signin.php">SIGN IN</a>';
						}
					 ?>
				...
				<div class="uiloginbutton signinButton loginButton" style="">
					<?php
						if ($user!="") {
							echo '<a style="text-decoration: none; color: black;" href="profile.php?uid='.$user.'">Hi '.$uname_db.'</a>';
						}
						else {
							echo '<a style="text-decoration: none; color: black;" href="login.php">LOG IN</a>';
						}
					 ?>
				</div>
			</div>
	...
	<div style=" padding: 0 10%;">
		...
		$result = mysqli_query($con,"SELECT * FROM user WHERE id='$user'");
			$get_user_email = mysqli_fetch_assoc($result);
				...
				$del = $_POST['Delivery'] ;
				echo '<h3 style="color:black;font-size:25px;">Type of Delivery:</h3>';
						...
						echo '
							...
							<div class="signupform_text"></div>
								...
								<form action="" method="POST" class="registration">
									...
									<h3 style="color:black;font-size:18px; padding: 5px;">Accepting CashOnDelivery Only</h3>
										<div>
											<td>
										...
										<font family="arial" size="5px" color="black">
										Types of Delivery <br>


										 <input name="Delivery" required="required" value="Express Delivery +Rs.100 upon delivery" type="radio"  placeholder="Mode Of Payment" style"color:black;"> Express </br>
										 <input name="Delivery" type="radio" value="Standard Delivery" required="required" placeholder="Mode Of Payment" style"color:black;"> Standard </br>
										 </font>
